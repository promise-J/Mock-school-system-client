...
const Anthem = () => {
    return <div className='welcome-page'>
        ...
        <div className="club-text">
            <p style={{fontFamily: 'Noto Serif Display', fontWeight: 600}}><span className='first-text'>O</span>ne  of the greatest things that happened to my life is that i belong to SOLUTION ACADEMY
