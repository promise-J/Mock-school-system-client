    ...
    return (
        <div className='homepage'>
          ...
          <div className="welcome" data-aos='zoom-in-right'>
              ...
              <p data-aos='fade-up'>"Every great dream begins with a dreamer. Always remember, you have within you the strength,
          ...
          <div className="image-voice">
              <div className="single-image-voice" data-aos='fade-right'>
                  ...
                  <p>You are most welcome to Solution Academy.
                       We are Purpose driven to serve you better...</p>
              ...
              <div className="single-image-voice" data-aos='fade-right'>
                  ...
                  <p>Every organisation that is headed aright have standards and we are not...</p>
                  <h1>OUR STANDARDS</h1>
                  </div>
              </div>
              <div className="single-image-voice" data-aos='fade-right'>
          ...
          <div className="image-voice">
              <div className="single-image-voice" data-aos='fade-left'>
                  ...
                  <p>Even thought you have seen enough in construction and Engineering field? Check this club out.</p>
              ...
              <div className="single-image-voice" data-aos='fade-left'>
                  <div className="single-content">
                  <Link to="/clubs">Read More</Link>
                  <p>Nothing beats our well in-form dancing group. Check it out now.</p>
              ...
              <div className="single-image-voice" data-aos='fade-left'>
                  <div className="single-content">
                  <Link to="/clubs">Read More</Link>
                  <p>This is the center of Home Responsibility. Home dishes are taught and served Hot here.</p>
              ...
              <div className="single-image-voice" data-aos='fade-left'>
                  <div className="single-content">
                  <Link to="/clubs">Read More</Link>
                  <p>The generations of AI. We Know just how much the world 
                      depends on Computer that is why we are committed to this course.</p>
                  <h1>Computer Club</h1>
                  </div>
              </div>
          ...
          <div className="recommendations">
              <div className="recommendation" data-aos='zoom-in-up'>
                  <p>"Solution is the best School by far in Awka North as far as quality is concerned"</p>
          ...
          <div className="recommendations">
              ...
              <div className="recommendation help">
                 <div className="recommendation-img img1">
                 </div>
              ...
              <div className="recommendation" data-aos='zoom-in-right'>
              <div className="recommendation help">
                 <div className="recommendation-img img3">
                 </div>
                 <Link to='#'>EXTRAS</Link>
              </div>
              </div>
